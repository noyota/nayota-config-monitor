...
Eightlu.prototype.changeAddr = function(options) {
  ...
  var commond = 'FF10020000050A00' + options.shortAddress + '0003000000000000'
...
Eightlu.prototype.encode = function(addr, parameters, port) {
  ...
  var cmds = []
  cmds = paramData(cmd1, commonds, pars['sd'], port, 0, cmds)
  cmds = paramData(cmd1, commonds, pars['wd'], port, 1, cmds)
...
/**
     * 读取数据
     */
Eightlu.prototype.read = function(addr, code) {
