...
Relay.prototype.read = function(addr, code) {
  ...
  var commond1 = this.validate.crc16(addr + '0320000002')	// 电压
  var commond2 = this.validate.crc16(addr + '0320020002')	// 电流
  var commond3 = this.validate.crc16(addr + '0340000002')	// 电能
  var cmd = []
  if (code.indexOf('1') > -1) {
    cmd.push(commond1)
  }
