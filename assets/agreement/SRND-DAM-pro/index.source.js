...
Relay.prototype.changeAddr = function(options) {
  ...
  // var jiaoyan = jiaoyanone.substr(jiaoyanone.length - 2, 2)
  var commond1 =  options.oldAddr+ '0600460055'
  commond1 = this.validate.crc16(commond1)
  var commond2 =  options.oldAddr+ '06004700AA'
  commond2 = this.validate.crc16(commond2)
  var commond3 =  options.oldAddr+ '06003900'+options.shortAddress
  commond3 = this.validate.crc16(commond3)
  cmd.push(commond1)
  cmd.push(commond2)
  cmd.push(commond3)
  var validate = this.validate
  ...
  return {
    ...
    resolve: function(result, success, error) {
      ...
      var item = rmDb(data[2])
      if (item.length < 16) {
        return error(400)
      }
      var data1 = item.substr(0, data[2].length - 4)
...
Relay.prototype.read = function(addr, code) {
  ...
  // var commond2=this.validate.crc16('5501'+addr+'010301')
  // var commond3=this.validate.crc16('5501'+addr+'010401')
  // var commond4=this.validate.crc16('5501'+addr+'010501')
  // var commond5=this.validate.crc16('5501'+addr+'012701')
  // var commond6=this.validate.crc16('5501'+addr+'012801')
  // if (code.indexOf('2') > -1) {
  cmd.push(commond1)
  // }
  // if (code.indexOf('3') > -1) {
  ...
  return {
    ...
    resolve: function(result, success, error) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        allChecks['3'] = item.substr(14, 4)
        allChecks['4'] = item.substr(18, 4)
        // res['0'] = parseInt(data[i].substr(26, 2))
      }
...
Relay.prototype.write = function(addr, code, state) { // 01 05 00 03 FF 00 7C 3A 线圈4 01 05 00 03 00 00 3D CA
  ...
  // var jiaoyan = jiaoyanone.substr(jiaoyanone.length - 2, 2)
  var commond ='5501' + addr + state + state3
