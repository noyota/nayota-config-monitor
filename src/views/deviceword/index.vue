<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('HardWareWord.type')" align="center" prop="type" min-width="100px">
      ...
      <el-table-column :label="$t('HardWareWord.code')" align="center" sortable="custom" prop="code" min-width="180px" />
      <el-table-column prop="updatedAt" :label="$t('table.updatedAt')" sortable="custom" align="center" min-width="150">
        <template slot-scope="scope">
...
import { list, deleteOne, deleteMany } from '@/api/deviceword'
